...
export default function Header() {
  ...
  return (
    <div className="w-full bg-transparent rounded z-10 grid-cols-5 flex items-center text-xs p-2 text-white px-4">
      {selectedLanguage === 'pt-BR' ? (
        <>
          <h1 className="w-1/4 flex gap-3 font-bold capitalize">
            Apostador
          </h1>
