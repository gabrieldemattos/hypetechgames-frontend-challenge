    ...
    <Modal show={show} toggle={toggle}>
      <div className="w-full rounded-md">
        <section className="modal-header py-1 flex justify-between items-center px-3  relative">
          <h1 className="text-1xl uppercase flex gap-4 p-3">
            Partida #{data.id}{' '}
            <span className="default-badget block mt-[-0.1875rem]">
              {data.extras?.point} x
            </span>
          </h1>
          <button
          ...
          <div className="px-6 py-4 flex flex-col gap-5">
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <ServerIcon className="w-8 h-8 pt-1 text-[#6c73a8] mt-[1.6875rem]" />
                <div>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex gap-2">
                <ShieldCheckIcon className="w-8 h-8 pt-1 text-[#6c73a8] mt-[1.6875rem]" />
                <div>
                  <p className="text-base font-bold text-white mt-6">
                    Hash SHA512 combinada
                  </p>
                  <p className="text-xs">
                    A seed acima mencionada é convertidas em hash
                    SHA512. Este é o resultado deste jogo
                  </p>
                </div>
              </div>
